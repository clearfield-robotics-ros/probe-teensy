...
std_msgs::UInt16MultiArray probe_status_reply;
ros::Publisher probe_status_reply_pub( "probe_status_reply", &probe_status_reply);
std_msgs::UInt16MultiArray probe_contact_reply;
ros::Publisher probe_contact_reply_pub( "probe_status_reply", &probe_contact_reply);
